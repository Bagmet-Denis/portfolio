...
const paperOverlay = '/paper_overlay.png'
...
const technologyIconMap: Record<string, string> = {
  swift: '/technologies/swift.svg',
  swiftui: '/technologies/swift.svg',
  uikit: '/technologies/swift.svg',
  combine: '/technologies/swift.svg',
  asyncawait: '/technologies/swift.svg',
  mvvm: '/technologies/swift.svg',
  ios: '/technologies/swift.svg',
  iossdk: '/technologies/swift.svg',
  xcode: '/technologies/xcode.svg',
  flutter: '/technologies/flutter.svg',
  dart: '/technologies/dart.svg',
  android: '/technologies/kotlin.svg',
  androidsdk: '/technologies/kotlin.svg',
  androidstudio: '/technologies/kotlin.svg',
  kotlin: '/technologies/kotlin.svg',
  ...
  sqlite: '/technologies/sqlite.svg',
  coredata: '/technologies/sqlite.svg',
  realm: '/technologies/mongodb.svg',
  postgresql: '/technologies/postgresql.svg',
  mysql: '/technologies/mysql.svg',
  visualstudiocode: '/technologies/vscode.svg',
  vscode: '/technologies/vscode.svg',
  cursor: '/technologies/vscode.svg',
  pycharm: '/technologies/pycharm.svg',
  git: '/technologies/github.svg',
  github: '/technologies/github.svg',
  postman: '/technologies/postman.svg',
  rest: '/technologies/swagger.svg',
  restapi: '/technologies/swagger.svg',
  graphql: '/technologies/graphql.svg',
  bloc: '/technologies/flutter.svg',
  cicd: '/technologies/github.svg',
  proxyman: '/technologies/postman.svg',
  burpsuite: '/technologies/postman.svg',
  charlesproxy: '/technologies/postman.svg',
  frida: '/technologies/python.svg',
  mobilere: '/technologies/python.svg',
  dynamicanalysis: '/technologies/python.svg',
  reverseengineering: '/technologies/python.svg',
  objection: '/technologies/python.svg',
  jadx: '/technologies/java.svg',
  apktool: '/technologies/java.svg',
  ghidra: '/technologies/java.svg',
  hopper: '/technologies/swift.svg',
  mobsf: '/technologies/python.svg',
  appsec: '/technologies/linux.svg',
  mobileappsec: '/technologies/linux.svg',
  webappsec: '/technologies/linux.svg',
  ctf: '/technologies/linux.svg',
  bugbounty: '/technologies/linux.svg',
