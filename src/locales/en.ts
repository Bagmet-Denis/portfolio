export default {
  ...
  projects: {
    ...
    descriptions: {
      ...
      plates: '<strong>Blin-da-Grif</strong> brings personalized workouts, an AI assistant, community, nutrition tracking, and progress insights into one mobile product.<br><br>Users choose a goal and level, receive a program, clarify difficult moments in the AI chat, and share results. The workout authors include <strong>Vladislav Tuinov</strong>, a three-time European kickboxing champion.',
